...
export class AllCustomersGQL extends Apollo.Query<
  AllCustomers.Query,
  AllCustomers.Variables
> {
  document: any = gql`
    query allCustomers {
      allCustomers {
...
export class AllProductsGQL extends Apollo.Query<
  AllProducts.Query,
...
export class AuthenticateAdminAccountGQL extends Apollo.Mutation<
  AuthenticateAdminAccount.Mutation,
  AuthenticateAdminAccount.Variables
> {
  document: any = gql`
...
export class CurrentAdminGQL extends Apollo.Query<
  CurrentAdmin.Query,
  CurrentAdmin.Variables
> {
  document: any = gql`
    query currentAdmin {
      currentAdmin {
...
export class CustomerByIdGQL extends Apollo.Query<
  CustomerById.Query,
...
export class RegisterAdminAccountGQL extends Apollo.Mutation<
  RegisterAdminAccount.Mutation,
  RegisterAdminAccount.Variables
> {
  document: any = gql`
    mutation registerAdminAccount($email: String!, $password: String!) {
      registerAdminAccount(input: { email: $email, password: $password }) {
        customer {
          id
        }
      }
...
export class UnprocessedFusionGQL extends Apollo.Query<
  UnprocessedFusion.Query,
  UnprocessedFusion.Variables
> {
  document: any = gql`
    query unprocessedFusion {
      allOrderItems(
        filter: {
          productSku: { equalTo: "fusion" }
          isProcessed: { equalTo: false }
        }
      ) {
        nodes {
          id
          ...
          orientation
          fusionType
          productLinksByOrderItemId(filter: { type: { equalTo: CROP } }) {
            nodes {
              url
            }
          }
...
export class UpdateOrderItemByIdGQL extends Apollo.Mutation<
  UpdateOrderItemById.Mutation,
  UpdateOrderItemById.Variables
> {
  document: any = gql`
    mutation updateOrderItemById($id: UUID!) {
      updateOrderItemById(
        input: { id: $id, orderItemPatch: { isProcessed: true } }
      ) {
        clientMutationId
      }
    }
...
export namespace AllCustomers {
  export type Variables = {};

  export type Query = {
    __typename?: "Query";

    allCustomers: Maybe<AllCustomers>;
  };
...
export namespace AuthenticateAdminAccount {
  export type Variables = {
    email: string;
    password: string;
  };
  ...
  export type Mutation = {
    ...
    authenticateAdminAccount: Maybe<AuthenticateAdminAccount>;
  };

  export type AuthenticateAdminAccount = {
...
export namespace CurrentAdmin {
  export type Variables = {};

  export type Query = {
    __typename?: "Query";

    currentAdmin: Maybe<CurrentAdmin>;
  };
...
export namespace CustomerById {
  ...
  export type Query = {
    ...
    customerById: Maybe<CustomerById>;
  };
  ...
  export type CustomerById = {
    ...
    ordersByCustomerId: OrdersByCustomerId;
  };

  export type OrdersByCustomerId = {
    __typename?: "OrdersConnection";
...
export namespace RegisterAdminAccount {
  export type Variables = {
    email: string;
    password: string;
  };
  ...
  export type Mutation = {
    ...
    registerAdminAccount: Maybe<RegisterAdminAccount>;
  };

  export type RegisterAdminAccount = {
...
export namespace UnprocessedFusion {
  export type Variables = {};

  export type Query = {
    __typename?: "Query";

    allOrderItems: Maybe<AllOrderItems>;
  };

  export type AllOrderItems = {
    __typename?: "OrderItemsConnection";
...
export namespace UpdateOrderItemById {
  export type Variables = {
    id: Uuid;
  };
  ...
  export type Mutation = {
    ...
    updateOrderItemById: Maybe<UpdateOrderItemById>;
  };

  export type UpdateOrderItemById = {
